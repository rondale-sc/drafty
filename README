...
the information by position on a single screen.  It also integrates a livesearch option to quickly allow teams to get an 
at a glance feelfor how what positions are available.
